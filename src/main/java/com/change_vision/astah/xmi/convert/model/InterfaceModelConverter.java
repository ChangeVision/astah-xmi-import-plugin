...
public class InterfaceModelConverter implements ModelConverter<IClass> {
    ...
    public InterfaceModelConverter(Map<String, Relationship> relationships, AstahAPIUtil util, ConvertHelper helper) {
        this.apiUtil = util;
