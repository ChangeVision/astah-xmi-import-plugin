...
import static util.UML2TestUtil.createAssociationClass;
...
public class AssociationClassConverterTest {
    ...
    public void before() throws Exception {
        ...
        converter = new AssociationClassConverter(util, helper);
    }
    ...
    public void rejectAssociationWithEmptyMemberEnds() {
        Relationship element = createAssociationClass("hoge");
    ...
    public void acceptAssociationWithSomeMemberEnds() {
        Association element = createAssociationClass("hoge");
